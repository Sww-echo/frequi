...
<template>
  <div class="flex flex-col items-stretch">
    <h3 class="font-bold text-2xl">{{ $t('backtest.availableResults') }}</h3>
    <ul
    ...
    >
      ...
      >
        ...
        <template v-if="result.metadata.editing">
          <UTextarea v-model="result.metadata.notes" :placeholder="$t('backtest.notes')" size="sm"> </UTextarea>
          <UButton
            size="sm"
