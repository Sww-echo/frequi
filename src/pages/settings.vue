...
const openTradesOptions = computed(() => [
  ...
  { value: OpenTradeVizOptions.noOpenTrades, text: t('settings.hideOpenTrades') },
]);
    ...
    <div class="flex flex-col gap-4 text-start dark:text-neutral-300">
      ...
      <div class="border border-neutral-400 rounded-sm p-4 space-y-4">
        ...
        <BaseCheckbox v-model="layoutStore.layoutLocked" class="space-y-1">
          {{ $t('settings.lockDynamic') }}
          <template #hint>{{ $t('settings.lockDynamicHint') }}</template>
        </BaseCheckbox>
        ...
        <BaseCheckbox v-model="settingsStore.confirmDialog" class="space-y-1">
          {{ $t('settings.confirmExit') }}
          <template #hint>{{ $t('settings.confirmExitHint') }}</template>
        </BaseCheckbox>

        <BaseCheckbox v-model="settingsStore.multiPaneButtonsShowText" class="space-y-1">
          {{ $t('settings.multiPaneText') }}
          <template #hint>{{ $t('settings.multiPaneTextHint') }}</template>
        </BaseCheckbox>
      </div>
      ...
      <div class="border border-neutral-400 rounded-sm p-4 space-y-4">
        ...
        <div class="space-y-1">
          <label class="block">{{ $t('settings.colorPreference') }}</label>
